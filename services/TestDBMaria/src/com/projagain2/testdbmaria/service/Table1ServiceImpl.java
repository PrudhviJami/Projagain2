...
import com.projagain2.testdbmaria.Table1;
 ...
 * @see Table1
 */
@Service("TestDBMaria.Table1Service")
@Validated
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("TestDBMaria.Table1Dao")
    ...
    @Transactional(value = "TestDBMariaTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "TestDBMariaTransactionManager")
    @Override
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "TestDBMariaTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "TestDBMariaTransactionManager", timeout = 300)
    @Override
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDBMaria for table Table1 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service TestDBMaria for table Table1 to {} format", options.getExportType());
